    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <ul class="filter">
            ...
            <li class="brand"><a href="#">Mobile Applications</a></li>
      ...
      <div class="row">
        <ul class="portfolio-area da-thumbs">
            ...
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="concept/pics/essay1.png" alt="Portfolio name" title="" />
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="concept/pics/essay1.png">
                ...
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>Five Star Essays</strong></h5>
                  <p>Essay writing platform</p>
                </div>
              </div>
          ...
          <li class="portfolio-item" data-id="id-2" data-type="brand">
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="concept/pics/jichoche1.png" alt="Portfolio name" title="" />
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="concept/pics/jichoche1.png">
							<i class="icon-bg-light icon-zoom-in icon-circled icon-2x"></i>
							</a>
                    <a href="portfolio-details2.php">
							<i class="icon-bg-light icon-link icon-circled icon-2x"></i>
							</a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>Wanjohi</strong></h5>
          ...
          <li class="portfolio-item" data-id="id-3" data-type="web">
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="concept/pics/task2.png" alt="Portfolio name" title="" />
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="concept/pics/task2.png">
							<i class="icon-bg-light icon-zoom-in icon-circled icon-2x"></i>
							</a>
                    <a href="portfolio-details3.php">
							<i class="icon-bg-light icon-link icon-circled icon-2x"></i>
							</a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>My Manager</strong></h5>
                  <p>To do list task manager</p>
                </div>
              </div>
            </div>
          </li>
          <li class="portfolio-item" data-id="id-4" data-type="brand">
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="concept/pics/wololo1.png" alt="Portfolio name" title="" />
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="concept/pics/wololo1.png">
							<i class="icon-bg-light icon-zoom-in icon-circled icon-2x"></i>
							</a>
                    <a href="portfolio-details4.php">
							<i class="icon-bg-light icon-link icon-circled icon-2x"></i>
							</a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>Fumlee</strong></h5>
                  <p>Online fashion shop</p>
                </div>
              </div>
            </div>
          </li>
       ...
       <!--    <li class="portfolio-item" data-id="id-0" data-type="web">
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="assets/img/portfolio/img-5.jpg" alt="Portfolio name" title="" />
                  <article class="da-animate da-slideFromRight">
                ...
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>Portfolio name</strong></h5>
          ...
          <li class="portfolio-item" data-id="id-0" data-type="graphic">
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="assets/img/portfolio/img-6.jpg" alt="Portfolio name" title="" />
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="assets/img/portfolio/big-1.jpg">
							<i class="icon-bg-light icon-zoom-in icon-circled icon-2x"></i>
							</a>
