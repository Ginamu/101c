...
<head>
   <meta charset="utf-8">
        ...
        <link rel="icon" href="fancy/img/fav-icon.png" type="image/x-icon" />
...
<br>
    ...
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur ipsum obcaecati iusto distinctio dignissimos rem, impedit quam similique necessitatibus delectus, repudiandae, ullam cumque tempora. Mollitia vitae, quasi doloribus! Sint, reiciendis.</p>
  </div>
	 <!-- ======== @Region: #footer ======== -->
  <footer id="footer" class="block block-bg-grey-dark" data-block-bg-img="img/bg_footer-map.png" data-stellar-background-ratio="0.4">
    <div class="container">
      ...
      <div class="row" id="contact">
        ...
        <div class="col-md-3">
          <address>
              <strong>Concept Developers Kenya</strong>
              <br>
              <i class="fa fa-map-pin fa-fw text-primary"></i> Nairobi, Kenya. 
              <br>
              <i class="fa fa-phone fa-fw text-primary"></i> +254 778 909915
              <br>
              <i class="fa fa-phone fa-fw text-primary"></i> +254 757 360151
              <br>
              <i class="fa fa-envelope-o fa-fw text-primary"></i> info@concept101.co.ke
              <br>
            </address>
        </div>
      ...
      <div class="row subfooter">
        ...
        <div class="col-md-7">
          <p>Copyright © Concept Developers</p>
          <div class="credits">
            <!--
 ...
 <!-- Required JavaScript Libraries -->
  ...
  <script src="contactform/contactform.js"></script>
        ...
        <script src="fancy/js/gmaps.min.js"></script>

        <!-- contact js -->
        <script src="fancy/js/jquery.form.js"></script>
        <script src="fancy/js/jquery.validate.min.js"></script>
        <script src="fancy/js/contact.js"></script>
